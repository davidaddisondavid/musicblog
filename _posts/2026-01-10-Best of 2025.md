...
I came across this album on the streaming platform Nina Protocol, where it was tagged with the following: #irish #guitar #laptop
...
Crimewave makes dance music composed only of guitars - no synths allowed. In an interview with Still Listening, he says: ‘In an age where you can open a laptop and essentially have access to any sound that’s ever existed, I think creatively it helps me having that boundary of only using the guitar.’

On *Scenes* this project is directed towards making a ‘conceptual dance album’ about nightlife in Northern England: Crimewave (Jake Wilkinson) remixed the album on decks once it was finished, so that the album has the pacing and fluidity of a DJ set, albeit a pretty unconventional and intense one. 
